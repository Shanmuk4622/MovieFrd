...
const CreateRoomModal: React.FC<CreateRoomModalProps> = ({ isOpen, onClose, onSubmit, isAnonymousDefault }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md border border-gray-700/50">
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6 space-y-4">
            ...
            <div>
              <label className="text-sm font-bold text-gray-400 block mb-2" htmlFor="room-name">
                Room Name
              </label>
              <input
                id="room-name"
            ...
            <div>
              <label className="text-sm font-bold text-gray-400 block mb-2" htmlFor="room-desc">
                Description (Optional)
              </label>
              <textarea
                id="room-desc"
                className="w-full p-3 bg-gray-700 rounded-md text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 h-24 resize-none"
                value={description}
            ...
            <div className="flex items-center justify-between bg-gray-700/50 p-3 rounded-md">
              <span className="font-semibold text-white">Anonymous Room</span>
          ...
          <div className="p-4 bg-gray-900/50 border-t border-gray-700/50 flex justify-end rounded-b-2xl">
            <button
              type="submit"
              disabled={loading}
