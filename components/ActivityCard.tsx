  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg p-4 flex items-start space-x-4 shadow-md">
      ...
      <div className="flex-1">
        ...
        <div className="mt-3 bg-gray-100 dark:bg-gray-700/50 rounded flex items-center p-2">
            <img src={activity.movie.posterUrl} alt={activity.movie.title} className="w-10 h-14 rounded object-cover"/>
            <div className="ml-3">
                <p className="font-semibold text-gray-900 dark:text-white text-sm">{activity.movie.title}</p>
